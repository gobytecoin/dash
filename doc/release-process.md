...
- Announce the release:
  ...
  - Optionally Discord, twitter, reddit /r/GoByte, ... but this will usually sort out itself

  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~gobytecoin/+archive/ubuntu/gobyte)
